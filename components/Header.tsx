    ...
    <Link href="/" className="flex items-center">
      ...
      >
        ...
        <g>
          ...
          />
          <path
            d="M199.509 14.9034L275.011 197.181C280.998 211.636 270.374 227.536 254.728 227.536C245.9 227.536 237.931 222.249 234.5 214.115L168.956 58.7301L157.93 32.1335C151.786 17.3153 162.677 1.01123 178.718 1.01123C187.82 1.01123 196.026 6.49417 199.509 14.9034Z"
          />
        </g>
        <g className={cx("transition-opacity duration-300", scrolled && !navOpen && "opacity-0")}>
